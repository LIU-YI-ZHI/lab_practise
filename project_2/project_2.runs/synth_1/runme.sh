...
HD_PWD='D:/FPGA_DATA/lab_practise/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log updown_2_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source updown_2_Counter.tcl
