...
HD_PWD='D:/FPGA_DATA/lab_practise/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_LED_SEG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_down_LED_SEG.tcl
