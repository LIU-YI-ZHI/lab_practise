...
HD_PWD='D:/FPGA_DATA/lab_practise/FourAdder/FourAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourAdder.tcl
