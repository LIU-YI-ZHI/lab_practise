...
HD_PWD='D:/FPGA_DATA/lab_practise/Drive_any/Drive_any.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Drive_any.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Drive_any.tcl
