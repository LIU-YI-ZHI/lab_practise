...
HD_PWD='D:/FPGA_DATA/lab_practise/FourAdder_CLA/FourAdder_CLA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourAdder_CLA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourAdder_CLA.tcl
