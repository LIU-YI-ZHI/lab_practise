...
synth_design -top FourAdder_CLA -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef FourAdder_CLA.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file FourAdder_CLA_utilization_synth.rpt -pb FourAdder_CLA_utilization_synth.pb"
